...
3. （选做但推荐）下载[PsSuspend](https://learn.microsoft.com/zh-cn/sysinternals/downloads/pssuspend)并将其中的```pssuspend64.exe```放在```C:/Windows/System32```之下，或者给文件所在位置加入PATH变量
